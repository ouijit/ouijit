...
export interface IpcInvokeContract {
  ...
  'task:create-and-start':        { args: [projectPath: string, name?: string, prompt?: string, branchName?: string]; return: TaskWorktreeResult };
  ...
  'worktree:get-diff':            { args: [projectPath: string, worktreeBranch: string, targetBranch?: string]; return: WorktreeDiffSummary | null };
  'worktree:get-file-diff':       { args: [projectPath: string, worktreeBranch: string, filePath: string, targetBranch?: string]; return: FileDiff | null };
  'worktree:merge':               { args: [projectPath: string, worktreeBranch: string];                   return: GitMergeResult };
  'worktree:ship':                { args: [projectPath: string, worktreeBranch: string, commitMessage?: string]; return: { success: boolean; error?: string; conflictFiles?: string[]; mergedBranch?: string } };
  ...
  'lima:set-config':              { args: [projectPath: string, config: { memoryGiB?: number; diskGiB?: number }]; return: { success: boolean } };
