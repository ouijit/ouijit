...
export function registerTagHandlers(): void {
  ...
  typedHandle('tags:remove-from-task', (projectPath, taskNumber, tagName) =>
    removeTagFromTask(projectPath, taskNumber, tagName),
  );
  typedHandle('tags:set-task-tags', (projectPath, taskNumber, tagNames) =>
    setTaskTags(projectPath, taskNumber, tagNames),
  );
}
