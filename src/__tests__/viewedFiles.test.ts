...
describe('files marked as read', () => {
  ...
  /**
   * The rule the whole feature rests on. A file you read and someone then
   * pushed to is a file you have not read, and quietly carrying "done" across
   * a push is how a review comes to cover code nobody looked at.
   */
  test('a new head clears what was marked against the old one', async () => {
    ...
    // And writing against the new head does not resurrect the old set.
